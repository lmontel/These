...
\section{À propos de la localisation de MRTF-A}
 ...
 \caption{Exemples de cellules classées comme MRTF-A Cytoplasmique, Homogène et Nucléaire, de gauche à droite respectivement (en noir, MRTF-A GFP).\label{Exemples_CHN}}
...
\caption{\label{AMC}Répartition initiale pour des cellules issues des mêmes expériences exprimant ou non le plasmide Actine mCherry (683 cellules témoin et 538 cellules expriment l'Actine mCherry). **** : $p<10^{-4}$}
\end{figure}
\begin{figure}
\includegraphics[scale=0.3]{Figures/AMC_translob.png}
\caption{\label{AMC_transloc}Proportion de cellules changeant au moins une fois d'état et proportion d'entrantes et de sortantes, pour les même expériences, selon que l'Actine mCherrry est exprimée ou non.}
\end{figure}
...
\begin{figure}
\includegraphics[scale=0.4]{Figures/CHN_montage_rincage.png} 
...
\begin{center}
\begin{figure}
\includegraphics[scale=0.6]{Figures/Etirement10_vs_0_dynamique.png} 
...
\begin{figure}
\includegraphics[scale=0.6]{Figures/Etirement30_vs_0_dynamique.png} 
...
\begin{figure}
\includegraphics[scale=0.45]{Figures/Etirement30_vs_0_translocations.png}
...
\begin{figure}[p]
\includegraphics[scale=0.4]{Figures/Lipo_vs_Nano.png}
...
\begin{figure}
\includegraphics[scale=0.3]{Figures/C2C12.png} 
...
\begin{figure}
\includegraphics[scale=0.45]{Figures/Et10_G_ratio.png} 
...
\begin{figure}
\includegraphics[scale=0.4]{Figures/Et30_MRTFA_FG.png} 
...
\end{figure}
\begin{figure}
\includegraphics[scale=0.4]{Figures/Et30_Aires.png} 
